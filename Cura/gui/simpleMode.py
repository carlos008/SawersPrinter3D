...
class simpleModePanel(wx.Panel):
	"Ventana de la interfaz de usuario principal para el modo Sencillo"
	def __init__(self, parent, callback):
		...
		self.printTypeHigh = wx.RadioButton(printTypePanel, -1, _("Impresion Calidad Alta"), style=wx.RB_GROUP)
		self.printTypeNormal = wx.RadioButton(printTypePanel, -1, _("Impresion Calidad Standard"))
		self.printTypeLow = wx.RadioButton(printTypePanel, -1, _("Impresion Calidad Rapida"))
		...
		if profile.getMachineSetting('gcode_flavor') == 'RepRap (Marlin/Sprinter)':
			printMaterialPanel.Show(False)

		self.printSupport = wx.CheckBox(self, -1, _("Imprimir soporte de estructura"))

		sizer = wx.GridBagSizer()
		self.SetSizer(sizer)

		sb = wx.StaticBox(printTypePanel, label=_("Seleccione el tipo de impresion:"))
	...
	def setupSlice(self):
		...
		put('retraction_min_travel', '1.5')
		put('retraction_speed', '75.0')
		put('retraction_amount', '4.5')
		put('retraction_extra', '0.0')
		put('travel_speed', '150')
		put('bottom_layer_speed', '50')
